# PYTHONPATH=. python utils/filtrar_arapiraca_por_pasta.py --pasta utils/filtrar_arapiraca.py --ano 2020 --mes 01
...
# parser.add_argument('--pasta', required=True, help='Caminho da pasta com os arquivos .txt')
...
for arquivo in os.listdir(caminho):
    ...
    if arquivo.endswith('.txt'):
        ...
        caminho_txt = os.path.join(caminho, arquivo)
